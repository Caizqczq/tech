...
package com.tech.backend.config.mcp;

import com.tech.backend.entity.mcp.McpServerConfig;
...
public class CustomMcpStdioTransportConfigurationBeanPostProcessor implements BeanPostProcessor {
	...
	public Object postProcessAfterInitialization(@NotNull Object bean, @NotNull String beanName) throws BeansException {
		...
		if (bean instanceof StdioTransportAutoConfiguration) {
			...
			log.debug("Enhancement McpStdioTransportConfiguration bean start: {}", beanName);
			...
			try {
				...
				log.debug("Registry McpServer config: {}", msc);
			...
			log.debug("Enhancement McpStdioTransportConfiguration bean end: {}", beanName);
		}

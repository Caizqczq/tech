...
public class IQSSearchEngine {
	...
	private IQSSearchResponse genericSearchResult(ResponseEntity<IQSSearchResponse> response) {
		...
		throw new AppException("Failed to search" + response.getStatusCode().value());
	}
